        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="{{ isset($root) == 'masterdata' ? 'active treeview' : 'treeview' }}">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li class="{{ $currentpage == 'category' ? 'active' : '' }}" ><a href="{{ route('category.index') }}"><i class="fa fa-circle-o"></i> Category</a></li>
                            <li class="{{ $currentpage == 'product' ? 'active' : '' }}" ><a href="{{ route('product.index') }}"><i class="fa fa-circle-o"></i> Product</a></li>
                            <li class="{{ $currentpage == 'user' ? 'active' : '' }}"><a href="{{ route('user.index') }}"><i class="fa fa-circle-o"></i> User</a></li>
                            <li class="{{ $currentpage == 'customer' ? 'active' : '' }}" ><a href="{{ route('customer.index') }}"><i class="fa fa-circle-o"></i> Customer</a></li>
                        </ul>
                        ...
                        <!-- <ul class="treeview-menu">
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li><a href="{{ route('product.index') }}"><i class="fa fa-circle-o"></i> Add Product</a></li>
                                </ul>
                            </li>
                        </ul> -->
                    </li>
                    <li class="{{ $currentpage == 'order' ? 'active' : '' }}">
                        <a href="{{ route('order.index') }}">
                            <i class="fa fa-dashboard"></i> <span>List Of Order</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="#">
